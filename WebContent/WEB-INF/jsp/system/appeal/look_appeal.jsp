	...
	<section class="panel panel-default">
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
					 name="AppealFormMap.translatorId" id="translatorId" value="${appeal.translatorId.nickname}" disabled="disabled" >
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control "
					 name="AppealFormMap.projectId" id="projectId" value="${appeal.projectId }" disabled="disabled">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">申诉方式</label>
				<div class="col-sm-9" >
				    <c:if test="${appeal.mode == '书面' }">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea rows="10" cols="5" type="text" class="form-control"
					 name="AppealFormMap.matter" id="matter" disabled="disabled">${appeal.matter}</textarea>
				</div>
			</div>
			 <div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
				<textarea rows="10" cols="5" type="text" class="form-control"
					 name="AppealFormMap.cause" id="cause" disabled="disabled" >${appeal.cause }</textarea>
				</div>
			</div>
          <div class="line line-dashed line-lg pull-in"></div>
          <div class="form-group">
