...
<script type="text/javascript" src="${ctx}/js/system/corpus/add.js"></script>
<style type="text/css">
#but button {
	margin-bottom: 5px;
	margin-right: 5px;
...
<body>
	...
	action="${pageContext.request.contextPath}/corpus/addCorpusNameD.shtml">
	<section class="panel panel-default">
		<div class="panel-body">
		<div class="form-group">
				<label class="col-sm-3 control-label">语料语言</label>
				<div class="col-sm-9">
					 <select id="oriLanguage" name="corpusTableListFormMap.oriLanguage"
		...
		<div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入客户描述" name="corpusTableListFormMap.remark" id="remark">
				</div>
			</div>
