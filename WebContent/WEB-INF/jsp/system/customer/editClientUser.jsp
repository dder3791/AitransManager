...
<body>
	...
	action="${pageContext.request.contextPath}/clientUser/editClientUser.shtml">
	<section class="panel panel-default">
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入公司中文名称" name="clientUserFormMap.realName" id="nameZH" value="${clientUserFormMap.realName }">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入公司英文名称" name="clientUserFormMap.company" id="nameEN" value="${clientUserFormMap.company }">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入公司英文名称" name="clientUserFormMap.job" id="shortName" value="${clientUserFormMap.job }">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<%-- <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入客户移动电话号码" name="clientUserFormMap.tel" id="tel" value="${clientUserFormMap.tel }">
				</div>
			</div>
