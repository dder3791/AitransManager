	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select class="form-control" name="customerId" id="cname">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入客户案号"
						name="customerReference" id="customerreference">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control rewardlength" name="wordLlength" id="length"
						placeholder="请输入稿长（必须是数字）">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control rewardlength" name="imageLength" id="length"
						placeholder="请输入稿长（必须是数字）">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control money"
						placeholder="请输入稿酬（数字或'.'链接）" name="companyReward" id="companyReward">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			
			<div class="form-group">
				<label class="col-sm-3 control-label">支付定金<br>单位:元
				</label>
				<div class="col-sm-9">
					<input type="text" class="form-control money" name="advance" id="companyReward">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			...
			<!-- <div class="form-group">
				<label class="col-sm-3 control-label">定金<br>单位:元</label>
				<div class="col-sm-9">
					<input type="text" class="form-control money"
						placeholder="请输入定金" name="companyReward" id="companyReward">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div> -->
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select class="form-control" name="languagePair" id="languagePair">
						<option value="">请选择...</option>
				...
				<div class="col-sm-9">
					<select class="form-control" placeholder="请选择译员" name="domain"
						...
						<c:forEach items="${domainMapperList }" var="domain">
							<option value="${domain.name }" selected="selected">${domain.name }</option>
						</c:forEach>
					</select>
				</div>
			</div>
		...
		<!-- 	<div class="form-group" id="verifierdiv" style="display: none;">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请选择创建时间"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请选择返稿时间"
						name="completeTime" id="completeTime" readonly="readonly"
						onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd'})">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			...
			<!-- <div class="form-group">
				...
				<div class="col-sm-9">
					<select class="form-control" name="projectState" id="projectState">
						<option value="0" selected="selected" id="noStart">未启动</option>
						<option value="1" id="transing" style="display: none;">正在翻译</option>
						<option value="2" id="verifying" style="display: none;">正在校验</option>
						<option value="3" id="auditorying" style="display: none;">正在审核</option>
						<option value="4" id="backing" style="display: none;">正在返稿</option>
						<option value="5" id="end" style="display: none;">已完成</option>
					</select>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div> -->
