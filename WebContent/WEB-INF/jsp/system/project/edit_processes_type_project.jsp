...
<body>
	...
	action="${pageContext.request.contextPath}/project/editEntity.shtml">
	<section class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入客户所在地" name="projectFormMap.address" 
						id="address" value="${project.address }">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入项目经理姓名" name="projectFormMap.head" 
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入客户描述" name="projectFormMap.description" 
