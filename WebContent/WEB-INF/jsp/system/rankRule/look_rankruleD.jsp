		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				    ...
				    name="RankRuleFormMap.rname" id="rname" value="${rankrule.rname}" readonly="readonly">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea cols="10" rows="10"  class="form-control"  
					 name="RankRuleFormMap.explain" id="explain" readonly="readonly">${rankrule.explain }</textarea>
				</div>
			</div>
