		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				    ...
				    name="regulationFormMap.rname" id="rname" value="${regulation.rname}">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea cols="10" rows="10"  class="form-control"  
					 name="regulationFormMap.explain" id="explain" >${regulation.explain }</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select  name="regulationFormMap.state"
							...
							<c:if test="${regulation.state eq '启用'}">
