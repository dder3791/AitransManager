...
<script type="text/javascript" src="${ctx}/js/system/term/addTermupload.js"></script>
<style type="text/css">
#but button {
	margin-bottom: 5px;
	margin-right: 5px;
...
<body>
	...
	action="${pageContext.request.contextPath}/term/uploadTerm1.shtml?termName=${termName }" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入术语名称" name="termName" id="termName"
						value="${termName }" disabled="disabled">
				</div>
			</div>
