...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/tradingRecordClient/list_transTrad.js"></script>
	<div class="m-b-md" onkeydown="BindEnter(event)">
		<form class="form-inline" role="form" id="searchForm" name="searchForm">
			...
			<a href="javascript:grid.exportData('/project/export.shtml?type=verify')" class="btn btn-info" id="search">导出excel</a>			
		</form>
	</div>
