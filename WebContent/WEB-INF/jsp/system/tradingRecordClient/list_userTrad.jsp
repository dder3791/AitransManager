...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/tradingRecordClient/list_userTrad.js"></script>
	<div class="m-b-md" onkeydown="BindEnter(event)">
		<form class="form-inline" role="form" id="searchForm" name="searchForm">
			...
			<a href="javascript:grid.exportData('/tradingRecordClient/export.shtml')" class="btn btn-info" id="search">导出excel</a>			
		</form>
	</div>
