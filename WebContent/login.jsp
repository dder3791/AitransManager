...
<script type="text/javascript" src="${ctx}/js/system/login/login.js"></script>
<!--[if lt IE 9]> 
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">爱译翻译管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
			...
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						...
						<!-- 2017年4月11日11:36:28 username改为accountName -->
						<input type="text" placeholder="accountName" name="accountName" value=""
			...
			<div class="form-actions">
				<!-- <span class="pull-left" style="width: 33%"><a href="#"
					...
					class="flip-link btn btn-danger" id="to-recover">一键初始化系统</a></span> -->
					 <span>
					 	<button type="button" id="addFun" class="btn btn-primary marR10">注&nbsp;&nbsp;册</button>
					 	<!-- <a href="javascript:transferRegister()" class="flip-link btn btn-info" id="register">注册为译员</a> -->
					 	<!-- <a href="register.jsp" class="flip-link btn btn-info" id="register">注册为译员</a> -->
					 	<%-- <a href="${pageContext.servletContext.contextPath }/transfer/register.shtml" class="flip-link btn btn-info" id="register">注册</a> --%>
					 </span>
