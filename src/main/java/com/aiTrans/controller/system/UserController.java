...
public class UserController extends BaseController {
	...
	//密码修改
	@RequestMapping("userUpdatePasswordLayer")
	public String userUpdatePasswordLayer(Model model) throws Exception {
		return Common.BACKGROUND_PATH + "/system/user/userUpdatePassword";
	}
